  ...
  return (
    <div className="container mx-auto px-4 py-12 md:py-16">
      <div className="text-center mb-12">
        <h1 className="font-headline text-4xl md:text-5xl">{t('contact_page_title')}</h1>
      ...
      <div className="grid md:grid-cols-2 gap-8 lg:gap-12 items-start">
        <Card className="shadow-lg">
          <CardHeader>
            <CardTitle className="font-headline text-2xl">{t('contact_info_card')}</CardTitle>
          </CardHeader>
          <CardContent className="space-y-6 text-lg">
            <div className="flex items-start gap-4">
              <MapPin className="h-6 w-6 mt-1 text-primary" />
              <div>
                <h3 className="font-bold">{t('contact_address')}</h3>
            ...
            <div className="flex items-start gap-4">
              ...
              <div>
                <h3 className="font-bold">{t('contact_whatsapp')}</h3>
            ...
            <div className="flex items-start gap-4">
              ...
              <div>
                <h3 className="font-bold">{t('contact_email')}</h3>
