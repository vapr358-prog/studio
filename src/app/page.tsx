    ...
    <div className="flex flex-col gap-0">
      ...
      <section className="relative h-[90vh] w-full flex items-center justify-center text-center overflow-hidden">
        ...
        <div className="relative z-10 p-8 inline-block mx-4 bg-white/10 backdrop-blur-md rounded-2xl border border-white/20">
          ...
          <Button asChild size="lg" className="mt-10 px-10 py-7 text-xl rounded-full shadow-lg hover:scale-105 transition-transform bg-primary hover:bg-primary/90 text-white font-bold">
      ...
      <section className="py-20 md:py-32 bg-background border-b border-primary/5">
        <div className="container mx-auto px-4">
          ...
          <div className="text-center mt-16">
            <Button asChild variant="outline" size="lg" className="border-primary text-primary hover:bg-primary hover:text-white rounded-full px-10 py-7 text-lg font-bold">
      ...
      <section className="py-24 bg-secondary/40 overflow-hidden">
        <div className="container mx-auto px-4">
          ...
          <div className="text-center">
            <Button asChild size="lg" className="rounded-full px-14 py-9 text-2xl shadow-xl hover:scale-105 transition-all bg-primary hover:bg-primary/90 text-white font-bold">
      ...
      <section className="py-24 bg-white/60 backdrop-blur-md border-b border-primary/5">
        <div className="container mx-auto px-4 grid md:grid-cols-2 gap-16 items-center">
          <div className="relative aspect-square rounded-[3rem] overflow-hidden shadow-2xl bg-pink-50">
            <img 
              src="/variedad.jpg" 
              alt="Variedad de Chocolate" 
              className="w-full h-full object-cover"
              onError={(e) => {
                (e.target as HTMLImageElement).src = 'https://images.unsplash.com/photo-1578985545062-69928b1d9587?w=800';
              }}
            />
          </div>
          <div className="flex flex-col items-start gap-6">
            ...
            <Button asChild size="lg" className="rounded-full px-12 py-8 text-xl shadow-lg bg-primary hover:bg-primary/90 text-white font-bold">
      ...
      {/* Category Sections - Tus Sueños en Tarta */}
      <section className="py-24 bg-secondary/30">
        <div className="container mx-auto px-4 grid md:grid-cols-2 gap-16 items-center">
          <div className="md:order-last relative aspect-square rounded-[3rem] overflow-hidden shadow-2xl bg-pink-50">
            <img 
              src="/tarta.jpg" 
              alt="Tus Sueños en Tarta" 
              className="w-full h-full object-cover"
              onError={(e) => {
                (e.target as HTMLImageElement).src = 'https://images.unsplash.com/photo-1535254973040-607b474cb8c2?w=800';
              }}
            />
          </div>
          <div className="flex flex-col items-start gap-6">
            <h2 className="font-headline text-6xl md:text-8xl text-primary leading-tight uppercase">
              {t('section_special_title')}
            </h2>
      ...
      <section id="contacto" className="py-24 bg-primary text-primary-foreground">
        <div className="container mx-auto px-4">
          ...
          <div className="text-center mt-16">
            <Button asChild size="lg" variant="secondary" className="rounded-full px-14 py-9 text-2xl shadow-xl hover:scale-105 transition-transform font-bold text-primary">
